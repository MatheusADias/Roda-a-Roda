...
-Peguei um código de um jogo da forca e estou tentando implementá-lo ao trabalho. Porém estou com dificuldade em fazer loops com [i],
pois os arrays tem dois vetores (um para quantidade de palavras e outro para quantidade de letras).
...
main(){
	...
	int i, sorteio,sorteiopalavras,palavrasorteada[17], tamanho=0, rodar;
...
//tentativa de descobrir a quantidade de letras da palavra escolhida. não deu certo
	//while(palavras1[sorteiopalavras][i] != '\0' || palavras2[sorteiopalavras][i] != '\0' ||palavras3[sorteiopalavras][i] != '\0' ||palavras4[sorteiopalavras][i] != '\0' ||palavras5[sorteiopalavras][i] != '\0'){
	//i++;
	//tamanho++;
	//}
