...
int main(){
	...
	/* boas vindas: */
	printf("Instituto Federal de Sao Paulo\nProjeto de Logica de Programacao para o primeiro semestre no curso de Analise e Desenvolvimento de Sistemas.\nProf: Jusceli.\n\n");
	printf("=============================================\n");
	printf("\tRoda a Roda do Silvio Santos!\n\nJogo feito com muito amor por:\n\n\tLucas Gallo (SP)\n\tMatheus Augusto (SP3030687)\n");
